...
import { GoogleAuthProvider,signInWithRedirect,signInWithPopup,GithubAuthProvider } from "firebase/auth";
        ...
        <div className="in_mini">
          ...
          <div className="userAuth_Container">
            ...
            <p className="have_account">
              ...
              <span className="loginBtn" onClick={() => navi("/Home/Login")}>
                Login
              </span>{" "}
            </p>
            ...
            <motion.div onClick={signInGoogle} className="google_container" whileTap={{ scale: 0.9 }}>
              <FcGoogle className="google_icon" />
              <p style={{color:'white'}} className="googleIcon_Txt">Sign in with Google</p>
            </motion.div>
            ...
            <motion.div onClick={signInGithub} className="google_container" whileTap={{ scale: 0.9 }}>
              <FaGithub className="github_icon" />
              <p style={{color:'white'}} className="googleIcon_Txt">
                Sign in with Github
              </p>
            </motion.div>
          </div>
